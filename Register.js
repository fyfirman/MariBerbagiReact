   ...
   cpasswordValidator(){
      if(this.state.cpassword == ""){
         ...
         if(this.state.cpassword != this.state.password){
            this.setState({cpasswordError: "Password ga cocok! Cocoknya sama doi kali ya hehe"})
         } else {
               ...
               <Card style={styles.card}>
                  ...
                  <Form style={styles.form}>
                     ...
                     <Label style={styles.label}>Username</Label>
                        ...
                        />
                        <Text style={styles.notifError}>{this.state.usernameError}</Text>
                     ...
                     <Label style={styles.label}>Konfirmasi Password</Label>
                        ...
                        />
                        <Text style={styles.notifError}>{this.state.cpasswordError}</Text>
                        
                  </Form>

                  <Content style={styles.content}>
                     <Text style={styles.term}>Dengan mendaftar akun Mari Berbagi saya menyetujui <Text style={styles.aturan}>Aturan Penggunaan Mari Berbagi</Text>.</Text>
                  </Content>
                  
                  <ButtonPrimary text="DAFTAR" onPress={this.submit}></ButtonPrimary>
