          ...
          <Content>
            ...
            <View style={styles.cardBarang}>
              ...
              <View style={styles.ketBarang}>
                ...
                <Text style={styles.descBarang}>
                  Pakaian bekas warna biru. Birunya enggak seperti langit, agak
                  tua sedikit.
                </Text>
              </View>
            </View>
            ...
            <View style={styles.containerPeminat}>
              ...
              <View style={styles.cardPeminat}>
                <View style={{ width: 255, paddingRight: 10 }}>
                  ...
                  <Text style={styles.descMinat}>
                    Barangnya akan langsung saya serahkan ke mereka yang
                    membutuhkan mas..
                  </Text>
                </View>
                <Image
