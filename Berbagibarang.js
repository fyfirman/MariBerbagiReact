...
import { Button,  Container, Card, Content, H1, Form, ListItem, Label, CheckBox, Root, Textarea } from 'native-base';
...
export default class Berbagibarang extends Component{
    ...
    namaBarangValidator(){
        ...
        if(this.state.name == ''){
            this.setState({namaBarangError: "Nama Barang masih kosong nih, isi dulu ya"})
        } else {
            if(!namaBarangIsValid){
                this.setState({namaBarangError: "Nama Barang tidak boleh ada simbol, kecuali kurung '( )' "})
            } else{
            ...
            <Container >
                <Content>
                    ...
                    <View style={styles.header}>
                        ...
                        <H1 light style={styles.judulPage}>BERBAGI BARANG</H1>
                        <Text style={styles.subtitlePage}>Pastikan barang yang kamu sumbang layak guna ya.</Text>
                    </View>
                    ...
                    <Card style={styles.card}>
                        ...
                        <Form style={styles.form}>
                            ...
                            />
                            <Text style={styles.notifError}>{this.state.namaBarangError}</Text>
                            ...
                            />
                            <Text style={styles.notifError}>{this.state.deskripsiError}</Text>

                            <Label style={styles.namaKolom}>Kategori Barang</Label>
                            <Dropdown
                            ...
                            <View>
                                ...
                                <TextInput
                                    onChangeText={JumlahBarang => this.setState({ JumlahBarang })}
                                    style={styles.kolomInput}
                                    onBlur={()=>this.jumlahBarangValidator}
                                    keyboardType={"numeric"}
                                />
                                <Text style={styles.notifError}>{this.state.jumlahBarangError}</Text>
                            </View>

                            <View style={styles.pilOngkir}>
                                <Label style={styles.namaKolom}>Apakah kamu bersedia COD?</Label>
                                <ListItem>
                                    <CheckBox 
                                        color="#F05E23"
                                    />
                            ...
                            <View style={styles.pilOngkir}>
                                <Label style={styles.namaKolom}>Apakah kamu menanggung biaya ongkir?</Label>
                                <ListItem>
                                    <CheckBox 
                                        color="#F05E23"
                                    />
                                    <Text style={styles.textPilOngkir}>Tanggung Biaya Pengiriman</Text>
                                </ListItem>
                                {/*
                                <CheckBox
                                    value={true}
                        ...
                        <Button block onPress={this.CheckTextInput} style={styles.buttonPrimary}>
